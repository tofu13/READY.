...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("LAX $1A", [0xA7, 0x1A]),
        ("LAX $1A,Y", [0xB7, 0x1A]),
        ("LAX $D020", [0xAF, 0x20, 0xD0]),
        ("LAX $F022,Y", [0xBF, 0x22, 0xF0]),
        ("LAX ($F2,X)", [0xA3, 0xF2]),
        ("LAX ($F2),Y", [0xB3, 0xF2]),
        ("LDA #$1A", [0xA9, 0x1A]),
        ("LDA $1A", [0xA5, 0x1A]),
        ...
        ("RLA $E0", [0x27, 0xE0]),
        ("RLA $E0,X", [0x37, 0xE0]),
        ("RLA $F1CA", [0x2F, 0xCA, 0xF1]),
        ("RLA $C1A0,X", [0x3F, 0xA0, 0xC1]),
        ("RLA $C1A0,Y", [0x3B, 0xA0, 0xC1]),
        ("RLA ($42,X)", [0x23, 0x42]),
        ("RLA ($42),Y", [0x33, 0x42]),
        ("ROL", [0x2A]),
        ("ROL $1A", [0x26, 0x1A]),
        ...
        ("SRE $E0", [0x47, 0xE0]),
        ("SRE $E0,X", [0x57, 0xE0]),
        ("SRE $F1CA", [0x4F, 0xCA, 0xF1]),
        ("SRE $C1A0,X", [0x5F, 0xA0, 0xC1]),
        ("SRE $C1A0,Y", [0x5B, 0xA0, 0xC1]),
        ("SRE ($42,X)", [0x43, 0x42]),
        ("SRE ($42),Y", [0x53, 0x42]),
        ("STA $1A", [0x85, 0x1A]),
        ("STA $1A,X", [0x95, 0x1A]),
